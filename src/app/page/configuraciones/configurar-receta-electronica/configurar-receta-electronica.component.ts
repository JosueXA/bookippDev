...
@Component({
    selector: 'app-configurar-receta-electronica',
    templateUrl: './configurar-receta-electronica.component.html',
    styleUrls: ['./configurar-receta-electronica.component.scss', '../../page.component.scss']
})
export class ConfigurarRecetaElectronicaComponent implements OnInit {
    sessionTraslate: any = {}
    ...
    iniciarPantalla() {
        ...
        this._pantallaServicio.mostrarSpinner();
        this._backService.HttpPost("catalogos/receta/getConfiguracionRecetaElectronica", {}, {}).subscribe(
            response => {
    ...
    guardarReceta() {
        ...
        if (this.camposIncorrectos === 0 && this.camposVacios === 0) {
            ...
            if (this.receta.bandConfiguracionRecetaExistente) {
                ...
                this._backService.HttpPost("catalogos/receta/guardarConfiguracionRecetaElectronica", {}, params).subscribe(
                    response => {
                        this._pantallaServicio.ocultarSpinner();
    ...
    verEjemplo() {
        ...
        this._backService.HttpPost("catalogos/receta/getPlantillaRecetaElectronica", {}, params).subscribe(
            response => {
